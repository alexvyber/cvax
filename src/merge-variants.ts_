...
// import type { ClassProp, Prettify } from "./"
...
//   const defaultVariants = getDefaultVariants(baseVariants.defaultVariants, newVariants.defaultVariants)

//   const compoundVariants = getCompoundVariants(baseVariants.compoundVariants, newVariants.compoundVariants)
...
// // getDefaultVariants
// function getDefaultVariants<T extends VariantSchema<any> | undefined, U extends VariantSchema<any> | undefined>(
//   left: T,
//   right: U
// ): Prettify<MergeObjects<T, U>> {
...
// // getCompoundVariants
// function getCompoundVariants<const T extends readonly any[] | undefined, const U extends readonly any[] | undefined>(
//   baseVariants: T,
//   newVariants: U
// ) {
